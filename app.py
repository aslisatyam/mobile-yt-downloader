...
# 🌟 Cookies file check karna authentication aur bot bypass ke liye
...
# Agar repo me cookie file hai toh automatic load ho jayegi
            ...
            try:
                with yt_dlp.YoutubeDL(YDL_COMMON_OPTS) as ydl:
                    ...
                    if is_playlist:
                        ...
                        for f in formats:
                            # 🌟 Sirf mixed video+audio formats lenge bina ffmpeg ke jhanjhat ke
